...
public class BuildAbortedCounterTest extends MockedRunCollectorTest {
    ...
    private void testSingleCalculation(int expectedCount) {
        BuildAbortedCounter sut = new BuildAbortedCounter(getLabelNames(), getNamespace(), getSubSystem());
