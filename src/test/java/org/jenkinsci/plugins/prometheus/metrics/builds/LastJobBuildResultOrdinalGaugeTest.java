...
public class LastJobBuildResultOrdinalGaugeTest extends MockedRunCollectorTest {
    ...
    public void testNothingCalculatedAsRunNotYetOver() {
        ...
        LastJobBuildResultOrdinalGauge sut = new LastJobBuildResultOrdinalGauge(getLabelNames(), getNamespace(), getSubSystem());
