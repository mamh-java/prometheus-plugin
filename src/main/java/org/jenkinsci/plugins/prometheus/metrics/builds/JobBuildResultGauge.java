...
public class JobBuildResultGauge extends BaseMetricCollector<Run, Gauge> {

    public JobBuildResultGauge(String[] labelNames, String namespace, String subsystem, String namePrefix) {
